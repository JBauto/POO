...
public class Main_grafo {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    if(nr_rdm != 0) System.out.println("Execution Time : "+elapsedTime+" ms (Average of = "+(elapsedTime/nr_rdm)+" ms)");
	    else System.out.println("Execution Time : "+elapsedTime+" ms (Average of = "+(elapsedTime)+" ms)");
